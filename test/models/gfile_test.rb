...
class GfileTest < MiniTest::Unit::TestCase
  def setup
    ...
    @gfile_write_task                   = @Fixture::Task.default     @read_stage,  1, @gfile, input: "stage1/task1"
    @gfile_read_task                    = @Fixture::Task.default     @write_stage, 1, @gfile, input: "stage2/task1"
  end
